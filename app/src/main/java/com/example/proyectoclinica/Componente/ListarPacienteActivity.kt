...
@Composable
public fun ListarPaciente(pacientes: java.util.HashMap<String, String>) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
        ...
        Text(text = "Pac." + pacientes["nombre_completo"].toString() + " - " + pacientes["telefono"].toString(),
            style = TextStyle(fontSize = 24.sp, fontWeight = FontWeight.Bold)
        )
        Text(text = pacientes["correo"].toString(),
