...
class RegPacietesActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            Column (
                ...
                Spacer(modifier= Modifier.padding(all= dimensionResource(id = R.dimen.espacio_min)))
                Button( onClick = {
                    leerServicio(dni,nombre_completo,correo,telefono)
                }) {
                    Text(text="Guardar")
                }
            }
    ...
    private fun leerServicio(dni:String, nombreCompleto: String, correo: String, telefono: String) {
        // Instantiate the RequestQueue.
        val queue = Volley.newRequestQueue(this)
        val url = Total.rutaServices+"pacientesinsert.php"
        // Request a string response from the provided URL.
        val stringRequest = object : StringRequest(
            Request.Method.POST, url,
            { response ->
                Log.d("DATOS",response)
                Toast.makeText(this,"Se ha registrado paciente con codigo:"+response,
