...
import com.example.proyectoclinica.Componente.ListarPaciente
...
class BuscarPacienteActivity : ComponentActivity() {
    ...
    private fun leerServicio() {
        ...
        val url = Total.rutaServices + "pacientes.php"
        ...
        val stringRequest = StringRequest(
            ...
            Response.ErrorListener { error ->
                ...
                Toast.makeText(this, "Error al obtener Paciente", Toast.LENGTH_SHORT).show()
            })
        ...
        setContent {
            Box {
                ...
                Column (modifier = Modifier.offset(x = 0.dp, y = 160.dp).padding(bottom = 160.dp)){
                    LazyColumn(content = {
                        items(items = arrayList, itemContent = { Pacientes ->
                            Column(
                                modifier = Modifier
                ...
                FloatingActionButton(onClick = {
                    startActivity(Intent(this@BuscarPacienteActivity,RegPacietesActivity::class.java))
    ...
    private fun seleccionarPaciente(pacientes: HashMap<String, String>) {
        //recuperand los datos
        val dni = pacientes["dni"]
        val nombre_completo = pacientes["nombre_completo"]
        val correo = pacientes["correo"]
        val telefono = pacientes["telefono"]
        ...
        val intent = Intent(this,ActPacienteActivity::class.java)
